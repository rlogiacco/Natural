...
class CucumberParsingTest extends AbstractParserTest<CucumberDocument> {

	@Test
	def void parseBlankDocument() {
		val model = parse('''
			# language: en
		''')

		assertThat(model, notNullValue())
		assertThat(model.feature, nullValue())
	}

	@Test
	def void parseFeatureWithNarrative() {
		val model = parse('''
			# language: en
		...
		assertThat(model, notNullValue())
		assertThat(model.feature, notNullValue())
		assertThat(model.feature.title, equalTo("Hello, Cucumber!"))
...
//		assertThat(validate(model), empty())
//		
//		val feature = model.feature
//		val t1 = feature.scenarios.get(0).steps.get(0).table
//		assertThat(t1, notNullValue())
//		assertThat(t1.rows, hasSize(1))
//		
//		val t2 = (feature.scenarios.get(1) as ScenarioOutline).examples.get(0).table
